...
var Slider_ch = (function(){
  ...
  function Slider_ch(container, options){
    var self = this;
    ...
    this.resetTimeout = function(){
      ...
      timeout = setTimeout(function () {
        if(getProperty(options, "play_direction", Slider_ch.FORWARDS) == Slider_ch.BACKWARDS){
          self.prev();
        }else{
          self.next();
        }
    ...
    this.showUI = function(level){
      if(level instanceof Array){
        ...
        for(var i = 0; i < level.length; i++){
          switch(level[i]){
            case Slider_ch.UI.PREV:{
              controls.prev.classList.remove("hidden");
              break;
            }
            case Slider_ch.UI.NEXT:{
              controls.next.classList.remove("hidden");
              break;
            }
            case Slider_ch.UI.PAUSE:{
              controls.pause.classList.remove("hidden");
              break;
            }
            case Slider_ch.UI.INDICATORS:{
              controls.indicators.classList.remove("hidden");
              break;
            }
          }
        ...
        if(level){
          self.showUI([Slider_ch.UI.PREV, Slider_ch.UI.NEXT, Slider_ch.UI.PAUSE, Slider_ch.UI.INDICATORS]);
        }else{
          self.showUI([]);
        }
      }else{
  ...
  Slider_ch.getDelay = function(){
    return delay;
  }

  Slider_ch.FORWARDS = "play_direction_next";
  Slider_ch.BACKWARDS = "play_direction_prev";
...
var Sliderr_ch = (function(){
  ...
  function Sliderr_ch(container, options){
    var self = this;
    ...
    this.resetTimeout = function(){
      ...
      timeout = setTimeout(function () {
        if(getProperty(options, "play_direction", Sliderr_ch.FORWARDS) == Sliderr_ch.BACKWARDS){
          self.prev();
        }else{
          self.next();
        }
    ...
    this.showUI = function(level){
      if(level instanceof Array){
        ...
        for(var i = 0; i < level.length; i++){
          switch(level[i]){
            case Sliderr_ch.UI.PREV:{
              controls.prev.classList.remove("hidden");
              break;
            }
            case Sliderr_ch.UI.NEXT:{
              controls.next.classList.remove("hidden");
              break;
            }
            case Sliderr_ch.UI.PAUSE:{
              controls.pause.classList.remove("hidden");
              break;
            }
            case Sliderr_ch.UI.INDICATORS:{
              controls.indicators.classList.remove("hidden");
              break;
            }
          }
        ...
        if(level){
          self.showUI([Sliderr_ch.UI.PREV, Sliderr_ch.UI.NEXT, Sliderr_ch.UI.PAUSE, Sliderr_ch.UI.INDICATORS]);
        }else{
          self.showUI([]);
        }
      }else{
  ...
  Sliderr_ch.getDelay = function(){
    return delay;
  }

  Sliderr_ch.FORWARDS = "play_direction_next";
  Sliderr_ch.BACKWARDS = "play_direction_prev";
...
var Sliderrr_ch = (function(){
  ...
  function Sliderrr_ch(container, options){
    var self = this;
    ...
    this.resetTimeout = function(){
      ...
      timeout = setTimeout(function () {
        if(getProperty(options, "play_direction", Sliderrr_ch.FORWARDS) == Sliderrr_ch.BACKWARDS){
          self.prev();
        }else{
          self.next();
        }
    ...
    this.showUI = function(level){
      if(level instanceof Array){
        ...
        for(var i = 0; i < level.length; i++){
          switch(level[i]){
            case Sliderrr_ch.UI.PREV:{
              controls.prev.classList.remove("hidden");
              break;
            }
            case Sliderrr_ch.UI.NEXT:{
              controls.next.classList.remove("hidden");
              break;
            }
            case Sliderrr_ch.UI.PAUSE:{
              controls.pause.classList.remove("hidden");
              break;
            }
            case Sliderrr_ch.UI.INDICATORS:{
              controls.indicators.classList.remove("hidden");
              break;
            }
          }
        ...
        if(level){
          self.showUI([Sliderrr_ch.UI.PREV, Sliderrr_ch.UI.NEXT, Sliderrr_ch.UI.PAUSE, Sliderrr_ch.UI.INDICATORS]);
        }else{
          self.showUI([]);
        }
      }else{
  ...
  Sliderrr_ch.getDelay = function(){
    return delay;
  }

  Sliderrr_ch.FORWARDS = "play_direction_next";
  Sliderrr_ch.BACKWARDS = "play_direction_prev";
...
var Sliderrrr_ch = (function(){
  ...
  function Sliderrrr_ch(container, options){
    var self = this;
    ...
    this.resetTimeout = function(){
      ...
      timeout = setTimeout(function () {
        if(getProperty(options, "play_direction", Sliderrrr_ch.FORWARDS) == Sliderrrr_ch.BACKWARDS){
          self.prev();
        }else{
          self.next();
        }
    ...
    this.showUI = function(level){
      if(level instanceof Array){
        ...
        for(var i = 0; i < level.length; i++){
          switch(level[i]){
            case Sliderrrr_ch.UI.PREV:{
              controls.prev.classList.remove("hidden");
              break;
            }
            case Sliderrrr_ch.UI.NEXT:{
              controls.next.classList.remove("hidden");
              break;
            }
            case Sliderrrr_ch.UI.PAUSE:{
              controls.pause.classList.remove("hidden");
              break;
            }
            case Sliderrrrr_ch.UI.INDICATORS:{
              controls.indicators.classList.remove("hidden");
              break;
            }
          }
        ...
        if(level){
          self.showUI([Sliderrrr_ch.UI.PREV, Sliderrrr_ch.UI.NEXT, Sliderrrr_ch.UI.PAUSE, Sliderrrr_ch.UI.INDICATORS]);
        }else{
          self.showUI([]);
        }
      }else{
  ...
  Sliderrrr_ch.getDelay = function(){
    return delay;
  }

  Sliderrrr_ch.FORWARDS = "play_direction_next";
  Sliderrrr_ch.BACKWARDS = "play_direction_prev";
