...
var Sliderr = (function(){
  ...
  function Sliderr(container, options){
    var self = this;
    ...
    this.resetTimeout = function(){
      ...
      timeout = setTimeout(function () {
        if(getProperty(options, "play_direction", Sliderr.FORWARDS) == Sliderr.BACKWARDS){
          self.prev();
        }else{
          self.next();
        }
    ...
    this.showUI = function(level){
      if(level instanceof Array){
        ...
        if(level){
          self.showUI([Sliderr.UI.PREV, Sliderr.UI.NEXT, Sliderr.UI.PAUSE, Sliderr.UI.INDICATORS]);
        }else{
          self.showUI([]);
        }
      }else{
  ...
  Sliderr.setDelay = function(_delay){
  ...
  Sliderr.getDelay = function(){
    return delay;
  }

  Sliderr.FORWARDS = "play_direction_next";
  Sliderr.BACKWARDS = "play_direction_prev";
...
var Sliderrr = (function(){
  ...
  function Sliderrr(container, options){
    var self = this;
    ...
    this.resetTimeout = function(){
      ...
      timeout = setTimeout(function () {
        if(getProperty(options, "play_direction", Sliderrr.FORWARDS) == Sliderrr.BACKWARDS){
          self.prev();
        }else{
          self.next();
        }
    ...
    this.showUI = function(level){
      if(level instanceof Array){
        ...
        for(var i = 0; i < level.length; i++){
          switch(level[i]){
            case Sliderrr.UI.PREV:{
              controls.prev.classList.remove("hidden");
              break;
            }
            case Sliderrr.UI.NEXT:{
              controls.next.classList.remove("hidden");
              break;
            }
            case Sliderrr.UI.PAUSE:{
              controls.pause.classList.remove("hidden");
              break;
            }
            case Sliderrr.UI.INDICATORS:{
              controls.indicators.classList.remove("hidden");
              break;
            }
          }
        ...
        if(level){
          self.showUI([Sliderrr.UI.PREV, Sliderrr.UI.NEXT, Sliderrr.UI.PAUSE, Sliderrr.UI.INDICATORS]);
        }else{
          self.showUI([]);
        }
      }else{
  ...
  Sliderrr.setDelay = function(_delay){
    if(typeof _delay === "number"){
      delay = _delay;
  ...
  Sliderrr.getDelay = function(){
    return delay;
  }

  Sliderrr.FORWARDS = "play_direction_next";
  Sliderrr.BACKWARDS = "play_direction_prev";
...
var Sliderrrr = (function(){
  ...
  function Sliderrrr(container, options){
    var self = this;
    ...
    this.resetTimeout = function(){
      ...
      timeout = setTimeout(function () {
        if(getProperty(options, "play_direction", Sliderrrr.FORWARDS) == Sliderrrr.BACKWARDS){
          self.prev();
        }else{
          self.next();
        }
    ...
    this.showUI = function(level){
      if(level instanceof Array){
        ...
        for(var i = 0; i < level.length; i++){
          switch(level[i]){
            case Sliderrrr.UI.PREV:{
              controls.prev.classList.remove("hidden");
              break;
            }
            case Sliderrrr.UI.NEXT:{
              controls.next.classList.remove("hidden");
              break;
            }
            case Sliderrrr.UI.PAUSE:{
              controls.pause.classList.remove("hidden");
              break;
            }
            case Sliderrrr.UI.INDICATORS:{
              controls.indicators.classList.remove("hidden");
              break;
            }
          }
        ...
        if(level){
          self.showUI([Sliderrrr.UI.PREV, Sliderrrr.UI.NEXT, Sliderrrr.UI.PAUSE, Sliderrrr.UI.INDICATORS]);
        }else{
          self.showUI([]);
        }
      }else{
  ...
  Sliderrrr.setDelay = function(_delay){
    if(typeof _delay === "number"){
      delay = _delay;
  ...
  Sliderrrr.getDelay = function(){
    return delay;
  }

  Sliderrrr.FORWARDS = "play_direction_next";
  Sliderrrr.BACKWARDS = "play_direction_prev";
